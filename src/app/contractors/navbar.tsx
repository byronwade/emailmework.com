...
const navigation = [
	...
	{ name: "Settings", href: "/contractors/settings" },
];

const userNavigation = [
	{ name: "Settings", href: "/contractors/settings" },
	{ name: "Billing", href: "/contractors/billing" },
	{ name: "Upgrade", href: "/contractors/upgrade" },
	{ name: "Sign out", href: "#" },
];
				...
				<>
					<div className="mx-auto w-full flex-1 px-3 sm:px-6">
						...
						<div className="-mb-px flex space-x-3 overflow-x-auto text-white sm:space-x-0">
							{navigation.map((item) => {
								const isActive = item.href === "/contractors/settings" ? pathname.includes("/settings") : pathname === item.href;
								return (
