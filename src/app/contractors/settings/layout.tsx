...
const navigation = [
	{ name: "General", href: "/contractors/settings", current: true },
	{ name: "Administrators", href: "/contractors/settings/administrators", current: false },
	{ name: "Beta Features", href: "/contractors/settings/beta-features", current: false },
	{ name: "Passwords", href: "/contractors/settings/passwords", current: false },
	{ name: "Plans", href: "/contractors/settings/plans", current: false },
];
