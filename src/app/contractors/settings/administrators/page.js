	...
	return (
		<>
			<div className="mb-4 flex flex-col gap-4 sm:flex-row sm:justify-between">
				<div>
					<h1 className="mb-sm text-xl font-semibold">Administrators</h1>
					<p className="text-white">Database administrators are able to create, manage, and connect to production branches.</p>
				</div>
				<div>
			...
			<div className="mt-3">
				<div className="w-full overflow-x-auto">
					<table className="w-full">
						<thead>
							<tr>
								<th scope="col" colSpan={2} className="w-full border-white/20">
									Administrator
								</th>
							</tr>
						</thead>
								...
								<td className="border-white/20">
									<div className="flex items-center justify-between">
										<div className="flex items-center space-x-1">
											...
											<div>
												<div className="whitespace-nowrap font-medium">Byron Wade</div>
												<div className="text-sm text-white">bcw1995@gmail.com</div>
											</div>
										</div>
										<div>
											<button type="button" className="focus-ring hover:bg-secondary text-primary bg-primary relative box-border inline-flex shrink-0 select-none items-center justify-center overflow-hidden whitespace-nowrap rounded border border-white/20 px-1.5 py-1 text-center text-sm font-semibold leading-none no-underline transition">
												Remove
											</button>
										</div>
									</div>
