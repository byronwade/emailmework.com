	...
	return (
		<>
			<div className="mb-4">
				...
				<p className="text-secondary">New features that are available as part of our limited beta program.</p>
			</div>
			<div className="mb-4 overflow-hidden rounded-lg border border-white/20">
				<div className="mx-auto max-w-2xl px-6 py-16 text-center">
					...
					<div className="text-secondary mb-3">There are no features currently in the beta program.</div>
				</div>
			</div>
		</>
	);
