...
export default function MainMenu() {
	...
	return (
		<div className="sticky top-0 z-10 flex h-full flex-col items-center justify-between bg-[#1c1c1c] px-4 pb-8 md:flex md:shrink-0">
			...
			<div className="sticky bottom-0 right-0 flex flex-col items-center justify-end gap-4 md:items-start">
				<Link href="/dashboard" className={`flex w-full shrink-0 gap-3 rounded-md px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out  hover:bg-[#3f3f3f]`}>
					<Home className={`${color}`} size="20" />
					<span className={`${color} xs:flex hidden items-center gap-1 md:hidden xl:flex`}>Job Postings</span>
				</Link>
				<Link href="/dashboard/settings" className={`flex w-full shrink-0 gap-3 rounded-md px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out  hover:bg-[#3f3f3f]`}>
					<Sliders className={`${color}`} size="20" />
					<span className={`${color} xs:flex hidden items-center gap-1 md:hidden xl:flex`}>Settings</span>
				</Link>
				<Link href="/dashboard/billing" className={`flex w-full shrink-0 gap-3 rounded-md px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out  hover:bg-[#3f3f3f]`}>
					<CreditCard className={`${color}`} size="20" />
					<span className={`${color} xs:flex hidden items-center gap-1 md:hidden xl:flex`}>Billing</span>
				</Link>

				<Link href="/dashboard/upgrade" className={`flex w-full shrink-0 gap-3 rounded-md bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out  hover:bg-[#3f3f3f]`}>
					<Star className={`${color}`} size="20" />
					<span className={`${color} xs:flex hidden items-center gap-1 md:hidden xl:flex`}>Upgrade</span>
				</Link>
				<Link href="#" className={`flex w-full shrink-0 gap-3 rounded-md px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out  hover:bg-[#3f3f3f]`} onClick={toggleMode}>
				...
				{/* <Link href="#" className={`flex shrink-0 gap-3 rounded-md px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out w-full  hover:bg-[#3f3f3f]`}>
				...
				<Link href="/logout" className={`flex w-full shrink-0 gap-3 rounded-md px-4 py-1.5 text-xs font-semibold shadow-sm duration-300 ease-in-out  hover:bg-[#3f3f3f]`}>
