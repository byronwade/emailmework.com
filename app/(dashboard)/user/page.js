...
const features = [
	...
	},
	{
		...
		content: (
			<div className="p-4 text-white">
				...
				<p className="mt-2">
					Completing your profile is a great way to appeal to customers · <Button variant="link">Edit profile</Button>
				</p>
			</div>
		),
	},
	...
	},
	{
		...
		content: (
			<div className="p-4 text-white">
				<p>
					Email <Mail className="inline w-4 h-4 mr-2" /> team@emailmework.com
				</p>
				<p>
	...
	},
	{
		...
		content: (
			<div className="p-4 text-white">
				...
				<p>Jane Smith: Very professional.</p>
				<Button variant="link" className="mt-2">
					View all reviews
				</Button>
			</div>
